...
// Connect to the original external Supabase project (kotobi.com) for all operations
...
// supabaseFunctions points to the same Supabase project where edge functions and GROQ_API_KEY are deployed
export const supabaseFunctions = createClient(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    storage: localStorage,
    persistSession: true,
    autoRefreshToken: true,
